                ...
                <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_300px]">
                    ...
                    <div className="overflow-hidden rounded-2xl border border-border bg-surface shadow-sm">
                        ...
                        <div className="relative h-[460px] overflow-hidden bg-[var(--color-canvas)]">
                            ...
                            {status === "running" ? (
                                <img
                                    src={`${API_BASE_URL}/api/v1/simulation/frame?v=${Math.floor(simulationTime)}`}
                    ...
                    <div className="lg:col-span-2 flex h-full flex-col">
                        {panelSignal ? (
                            <div className="relative h-full">
                                {recommendationLoading && mappedRec && (
                                    <span className="absolute right-3 top-3 z-10 rounded-full bg-accent-blue/15 px-2 py-1 text-[10px] text-accent-blue">
                                        Menerapkan skenario…
                                    </span>
                                )}
                                <RecommendationPanel
